...
import { addItemToCart, removeItemFromCart, updateCartQuantity } from '../../action/cartAction';
...
export default function FoodItem({fooditem, restaurant}) {
    ...
    useEffect(() => {
        const cartItem = cartItems.find(
            (items) => items.foodItem._id === fooditem._id
        );
        if(cartItem){
    ...
    const addToCartHandler = () => {
        ...
        if(fooditem && fooditem._id){
            ...
            console.log("Food Item id not defines");
        }
    };
